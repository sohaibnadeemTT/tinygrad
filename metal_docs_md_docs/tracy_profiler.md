...
Please refer to [Device Program Profiler<device_program_profiler>](#Device Program Profiler<device_program_profiler>) for more detailed overview of device side profiling with tracy.
