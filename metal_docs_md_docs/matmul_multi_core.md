<a name="MatMul_Multi_Core example"></a>
...
core matmul example into one that will use as many cores as possible.  To see a more complicated example using data reuse among these cores, please refer to the [Matmul
multi-core data reuse example<MatMul_Multi_Core_Data_Reuse_example>](#Matmul
