<a name="MatMul_Multi_Core_Data_Reuse_example"></a>
...
Those are the additional steps for getting `matmul_multicore_data_reuse`` operations up and running on the compute engine. To see a more complicated example using core-to-core data movement, please refer to the [Matmul multi-core data mcast example<MatMul_Multi_Core_Optimized_Data_Mcast_example>](#Matmul multi-core data mcast example<MatMul_Multi_Core_Optimized_Data_Mcast_example>).
