...
``python
    ...
    class BertIntermediate(torch.nn.Module):
        d<a name="_init__(self, config)"></a>
            super().__init__()
...
Additional examples can be found in [the integration tests](https://github.com/tenstorrent/tt-metal/tree/main/tests/ttnn/integration_tests).
