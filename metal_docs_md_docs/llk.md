...
There is an emulator for the SFPU that works at t<a name="_builtin level.
...
vector to memory will result in an error similar to the following"></a>

.. code-block:: c++

    tt-metal/tt_metal/hw/ckernels/sfpi/include/sfpi.h:792:7: error: cannot write sfpu vector to memory
      792 |     v = (initialized)<a name="_builtin_rvtt_sfpassign_lv(v, in) "></a> in;
          |       ^
    /tt-metal/tt_metal/hw/ckernels/sfpi/include/sfpi.h:792:7: error: cannot write sfpu vector to memory
